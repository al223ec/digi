...
namespace DigitalentCoreApp.Controllers
{
    public class ConsultantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,FirstName,LastName,BirthDate,Phone,Adress,ZipCode")] Consultant consultant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstName,LastName,BirthDate,Phone,Adress,ZipCode")] Consultant consultant)
        {
            if (id != consultant.ID)
            {
                return NotFound();
