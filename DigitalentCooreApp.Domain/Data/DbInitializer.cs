...
namespace DigitalentCoreApp.Domain.Data
{
    public static class DbInitializer
    {
        public static void Initialize(DigitalentContext context)
        {
            ...
            {
                new Consultant{FirstName="Carson", LastName="Alexander", Adress="Fräsplan 36", ZipCode="56 567", Phone="070 89772543"},
                new Consultant{FirstName="Meredith", LastName="Alonso", Adress="Stansvägen 45", ZipCode="129 39", Phone="070 843578345"},
                new Consultant{FirstName="Arturo", LastName="Anand", Adress="Klubbacken 34", ZipCode="435 09", Phone="070 8943578324"},
                new Consultant{FirstName="Gytis", LastName="Barzdukas", Adress="Idrottsparken 35", ZipCode="324 45", Phone="070 3247787"},
                new Consultant{FirstName="Yan", LastName="Li", Adress="Kaptenkläningsväg 85", ZipCode="454 66", Phone="070 8977787"},
                new Consultant{FirstName="Peggy", LastName="Justice", Adress="Jörnboda 1235", ZipCode="545 645", Phone="073 3123787"},
                new Consultant{FirstName="Laura", LastName="Norman", Adress="Björnvägen 23", ZipCode="45 566", Phone="070 89777467"},
                new Consultant{FirstName="Nino", LastName="Olivetto", Adress="Järnvägen 45", ZipCode="45 456", Phone="076 6554544"}
            };
